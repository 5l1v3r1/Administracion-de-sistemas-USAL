<?php
    ...
    if ($rol === -1){                                                                                    
        ...
        include("header.php");
        include('/var/www/user/menu.php');                                                        
    } else if ($rol === 2){
        include('header.php');                                                                                             
        include('/var/www/admin/menu.php');
    }
        ...
        <?php 
            ...
            foreach ($dir_contents as $file) {
                ...
                if(in_array($extension, $ext_allowed)){
                    echo "<li><a href='$my_dir/$file'><img src='http://mmacademy.es/icons/$extension.svg' alt='$file'>$file</a></li>";
                }
            }
            echo '</ul>';
            $rol = check_rol();
